...
file_path <- '~/Dropbox/Metabolomics/MBX_01_02_03-IIRN/Final_datasets/'
f_path2 <- "~/Dropbox/Metabolomics/MBX_01_02_03-IIRN/Paper/CURE_for_paper2/"

f_path1 <- "~/Dropbox/Metabolomics/MBX_01_02_03-IIRN/Paper/Submissions/Revisions/Dec2024/Paper_2/Github/"
```
...
cure_data <- paste0(f_path2,"CURE_Stool_data_s418_f404_v2.csv") |> read_csv()
cure_map <- paste0(f_path2,"CURE_nina_paper2_map_20jan25.tsv") |> 
  read_tsv()
...
cure_data <- cure_data |> select(Feature, all_of(cure_map$metabolomics_ID))
```
